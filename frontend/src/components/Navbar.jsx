    ...
    <>
      ...
      >
        <div className="bg-[#050505]/95 backdrop-blur-2xl px-2.5 sm:px-6 py-1.5 sm:py-2.5 flex items-center justify-between rounded-full border border-[#C9A84C]/40 shadow-[0_12px_35px_rgba(0,0,0,0.9)] w-full min-w-0 flex-nowrap">
          ...
          <div className="flex items-center justify-end gap-1.5 sm:gap-2.5 shrink-0 flex-nowrap">

            {/* Search Icon Button */}
            <button
              onClick={toggleSearch}
              className="relative w-[27px] h-[27px] sm:w-8 sm:h-8 rounded-full bg-[#121212] border border-[#26241E] hover:border-[#C9A84C]/60 flex items-center justify-center text-[#FFF5D6] hover:text-[#C9A84C] transition-all duration-300 shrink-0 cursor-pointer"
            ...
            {(!isAuthenticated || (isAuthenticated && user && user.role === 'user')) && (
              <Link
                to="/user/wishlist"
                className={`relative w-[27px] h-[27px] sm:w-8 sm:h-8 rounded-full bg-[#121212] border border-[#26241E] hover:border-[#C9A84C]/60 flex items-center justify-center text-[#FFF5D6] hover:text-[#C9A84C] transition-all duration-300 shrink-0 ${
