...
export const BannerCarousel = () => {
  ...
  return (
    <section className="relative w-full h-[70vh] min-h-[460px] md:h-[80vh] lg:h-[88vh] overflow-hidden rounded-2xl lg:rounded-3xl select-none shadow-2xl">
      ...
      <AnimatePresence initial={false}>
        ...
        >
          <img
            ...
            draggable={false}
          />
          <div className="absolute inset-0 bg-gradient-to-r from-black/95 via-black/60 to-black/20 md:to-transparent" />
      ...
      <button
        onClick={prev}
        className="absolute left-2 sm:left-4 md:left-6 top-1/2 -translate-y-1/2 z-20 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 flex items-center justify-center rounded-full bg-black/70 backdrop-blur-md border border-[#C9A84C]/40 text-[#C9A84C] hover:bg-[#C9A84C] hover:text-black active:scale-90 transition-all duration-300"
