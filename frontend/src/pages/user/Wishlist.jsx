...
import { Heart, Compass, ChevronRight, Grid, Sparkles } from 'lucide-react'
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2 items-center">
                <button
                  ...
                  className={`text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-full border transition-all duration-200 cursor-pointer ${
                    activeFilter === 'all'
                ...
                <button
                  ...
                  className={`text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-full border transition-all duration-200 cursor-pointer flex items-center gap-1 ${
                    activeFilter === 'offers'
                      ? 'bg-[#C9A84C] text-black border-[#C9A84C] shadow-md'
                      : 'bg-[#0A0A0A] text-[#E8E0CC]/70 border-[#26241E] hover:border-[#C9A84C]'
                  }`}
